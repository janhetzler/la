...
# System Dependencies (chromadb benoetigt Rust + build-essential)
...
# Inferenz: llama-server Binary b9895 (kein llama-cpp-python)
...
ENV CHROMA_NOTES_COLLECTION=notes
